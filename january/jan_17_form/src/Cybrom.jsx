  ...
  return (
    <>
      {/* <h1>my application form</h1>
       ...
       Enter name: <input type="text" placeholder="Name" name="stuname" value={name} onChange={(e)=>setName(e.target.value)}/>  
        <br />
        <br />
        Enter city: <input type="text" placeholder="city" name="" value={city} onChange={(e)=>setCity(e.target.value)} />
        <br /><br />
